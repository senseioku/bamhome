          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden">
              <Sheet>
                ...
                <SheetContent side="right" className="!w-screen !h-screen p-0 bg-gray-900 border-0 !max-w-none !inset-0 !fixed !top-0 !left-0 !right-0 !bottom-0 sm:!w-80 !z-[9999]">
                  <div className="flex flex-col min-h-screen h-screen w-screen bg-gray-900/98 backdrop-blur-sm relative z-[10000] !fixed !inset-0 overflow-hidden">
                    {/* Compact Header */}
